    ...
    private Boolean isComparisonIncomplete(ClauseWithVars clauseWithVars, OracleDatapoint oracleDatapoint) {
        ...
        if (
                !(
                        ...
                        (!leftPrimitive && !rightPrimitive && isType1InstanceOfType2(fullyQualifiedClassName(leftType), fullyQualifiedClassName(rightType), oracleDatapoint)) || // 5)
                        (!leftPrimitive && !rightPrimitive && isType1InstanceOfType2(fullyQualifiedClassName(rightType), fullyQualifiedClassName(leftType), oracleDatapoint)) // 6)
                ) && (
