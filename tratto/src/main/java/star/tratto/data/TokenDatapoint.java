...
public class TokenDatapoint {
    ...
    public TokenDatapoint(Integer id, Boolean label, OracleDatapoint oracleDatapoint, String oracleSoFar, List<String> tokenClassesSoFar, String token, String tokenClass, List<String> tokenInfo) {
        this.id = id;
        this.label = label;
