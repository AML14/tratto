    ...
    public void detectPersistentErrorColumnsTest() {
        ...
        for (String stringOracle : stringOracles) {
            ...
            if (!columnsToCheck.isEmpty()) {
                fail(String.join(System.lineSeparator("The following oracle contains a sequence of tokens such that the same column is marked with an error five or more times:",
                                                      stringOracle,
