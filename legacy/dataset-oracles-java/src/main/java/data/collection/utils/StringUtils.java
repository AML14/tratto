...
public class StringUtils {
    ...
    /**
     * Join a partial expression with a token, adding a space between them.
     */
    public static String appendToken(String partialExpression, String token) {
        return partialExpression + " " + token;
    }
