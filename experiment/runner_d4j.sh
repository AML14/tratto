...
# This script runs evosuite tests on a Defects4J project, using a script provided by the authors of the Defects4J project
...
# Generate path to test-suite output directory, if it does not exist
