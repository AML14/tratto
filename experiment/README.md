 ...
 * To generate test prefixes, we use [EvoSuite](https://www.evosuite.org/).
   (EvoSuite generates complete unit tests (including the oracle); we remove the generated oracles (assertions) using [JavaParser](https://javaparser.org/).)
