...
We store three primary output JSON records: [OracleOutput](#241-OracleOutput), [TestOutput](#242-testoutput), and [Defects4JOutput](#243-defects4joutput). All outputs generated during the experimental pipeline are saved in the `experiment/output/` directory. This directory has various subdirectories, including:
