...
def main():
    ...
    for fold in range(args.folds):
        ...
        # Assign the weights to the different datasets
        ...
        # Instantiate cross-entropy loss function to measure the error during the training and validation phase
        ...
        classifier_ids_classes = data_processor.get_encoder_ids_classes()
