...
--checkpoint_path_token_classes checkpoints/token-classes-checkpoint/classes_decoder_category/pytorch_model.bin \
--checkpoint_path_token_values checkpoints/token-values-checkpoint/values_decoder_category/pytorch_model.bin